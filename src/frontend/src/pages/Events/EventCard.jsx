...
function EventCard({ title, date, description, image, details }) {
  ...
  return (
    <motion.div
      layout
      className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100 hover:shadow-2xl hover:scale-[1.02] hover:-translate-y-1 transition-all duration-500 cursor-pointer"
    ...
    >
      ...
      <div className="p-6">
        <h3 className="text-2xl font-bold text-gray-900 mb-3 font-serif hover:text-black transition-colors duration-300">{title}</h3>
