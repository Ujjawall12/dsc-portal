...
function AboutUs() {
  ...
  <a
    href="#about"
    className="font-medium text-gray-700 hover:text-[#4285F4] transition-all duration-300 hover:underline underline-offset-4"
  >
    About
  </a>
  <a
    href="#stats"
    className="font-medium text-gray-700 hover:text-[#34A853] transition-all duration-300 hover:underline underline-offset-4"
  >
    Stats
  </a>
  <a
    href="#contact"
    className="font-medium text-gray-700 hover:text-[#EA4335] transition-all duration-300 hover:underline underline-offset-4"
  >
    Contact
  </a>
  <a
    href="#faq"
    className="font-medium text-gray-700 hover:text-[#FBBC05] transition-all duration-300 hover:underline underline-offset-4"
  >
    FAQ
  </a>
  <a
  ...
  >
        ...
        <section id="about" className="flex flex-col md:flex-row items-center justify-between bg-gray-50 shadow p-8 my-4 rounded-lg">
          <div className="flex-1 space-y-4">
            <h1 className="text-5xl font-extrabold text-[#4285F4] leading-tight tracking-wide mb-6">
          ...
          <div className="flex-1">
            <img
              src={about}
              alt="About GDSC"
              className="rounded-lg shadow-lg w-full md:w-[600px] lg:w-[700px] h-[700px] transform hover:scale-105 transition duration-500 ease-in-out"
            />
          </div>
        </section>
        ...
        <section id="stats" className="grid grid-cols-1 md:grid-cols-4 gap-4 p-8 bg-gray-100 rounded-lg my-8">
          {[
            ...
            <div
              ...
              className="text-center bg-white p-4 rounded-lg shadow transform transition-all duration-300 hover:shadow-lg hover:translate-y-[-2px] cursor-pointer"
            >
        ...
        <section id="domains" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-8 bg-gray-50 rounded-lg my-8">
          {[
            ...
            <div
              key={index}
              className={`p-6 shadow-lg rounded-lg transform transition-all duration-300 hover:shadow-xl hover:translate-y-[-2px] relative overflow-hidden ${domain.bgColor}`}
            >
              ...
              <p className="text-white opacity-0 transition-opacity duration-300 hover:opacity-100">
                {domain.description}
              </p>
            </div>
          ))}
        ...
        <section id="contact" className="text-center my-8">
          ...
          <div className="flex justify-center space-x-6">
            <a
              href="https://www.instagram.com/dsc_nith?igsh=MWQ5dXdreG5hbnlvMw=="
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center text-black-600 hover:text-blue-700 transition-all duration-300 hover:translate-y-[-2px]"
            >
              <img
            ...
            <a
              href="https://www.linkedin.com/company/dsc-nit-hamirpur/"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center text-black-600 hover:text-blue-700 transition-all duration-300 hover:translate-y-[-2px]"
            >
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                ...
                className="p-4 bg-white shadow rounded-lg cursor-pointer transform transition-all duration-300 hover:shadow-lg hover:translate-y-[-2px]"
              >
