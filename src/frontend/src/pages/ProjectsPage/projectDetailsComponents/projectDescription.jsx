    ...
    <div className="w-full max-w-7xl mx-auto p-6 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <CardContent>
            <ul className="space-y-2">
              {projectInfo.technologies.map((tech, index) => (
                <li
                  key={index}
                  className="flex items-center p-2 rounded-lg hover:bg-gray-50 transition-all duration-300"
                >
        ...
        <Card className="p-6 hover:shadow-lg transition-shadow duration-300">
          ...
          <CardContent>
            <ul className="space-y-2">
              <li className="text-blue-500 hover:text-blue-600 flex items-center gap-2 p-3 rounded-lg hover:bg-gray-50 transition-all duration-300">
              ...
              {projectInfo.additionalRepositories.map((repo, index) => (
                <li
                  key={index}
                  className="text-blue-500 hover:text-blue-600 flex items-center gap-2 p-3 rounded-lg hover:bg-gray-50 transition-all duration-300"
                >
                  <GitBranch className="w-5 h-5" />
                  <a
                    href={repo.link}
