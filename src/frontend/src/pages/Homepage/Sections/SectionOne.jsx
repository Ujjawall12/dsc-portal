...
function SectionOne() {
  return (
    <section className="flex flex-col w-full h-[150vh] md:h-screen">
      <div className="flex flex-row justify-around items-center w-full flex-1">
        <div className="flex flex-col gap-4 items-center">
          <span className="font-Exo font-medium text-3xl text-neutral-700">
            Welcome to the Developers Club
          </span>
        </div>
      </div>
      <div className="flex flex-col md:grid md:grid-cols-4 lg:flex lg:flex-row bg-neutral-200 p-1 gap-1">
