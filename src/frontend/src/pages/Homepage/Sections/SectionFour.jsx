...
function BentoLink({
  ...
  return (
    <Link
      to={link}
      className={`transform-gpu transition-colors duration-300 relative overflow-hidden group cursor-pointer ${parentClassName}`}
    >
      {svg}
      <span
        className={`text-white font-semibold text-xl lg:text-3xl ml-2 absolute -bottom-12 left-1/2 transition-transform duration-300 whitespace-nowrap ${textClassName} transform-gpu`}
      >
        {text}
      </span>
    </Link>
...
const list = [
  {
    ...
    svg: (
      <svg
        ...
        viewBox="0 0 24 24"
        className="transform-gpu size-7 sm:size-10 md:size-12 lg:size-16 fill-white absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 group-hover:-translate-y-[80%] transition-transform duration-300"
      >
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="transform-gpu size-7 sm:size-10 md:size-12 lg:size-16 fill-white absolute top-1/2 left-1/2 -translate-x-[20%] -translate-y-[60%] group-hover:-translate-y-[80%] transition-transform duration-300"
      >
  ...
  },
  {
    ...
    svg: (
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="transform-gpu size-7 sm:size-10 md:size-12 lg:size-16 fill-white absolute top-1/2 left-1/2 -translate-x-[45%] -translate-y-1/2 group-hover:-translate-y-[80%] transition-transform duration-300"
      >
  ...
  },
  {
    svg: (
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="transform-gpu size-7 sm:size-10 md:size-12 lg:size-14 fill-white absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 group-hover:-translate-y-[80%] transition-transform duration-300"
      >
        <path
          fillRule="evenodd"
