    ...
    <div className='flex flex-col gap-4 min-h-screen px-8 items-center'>
      ...
      <div className='grid grid-cols-5 grid-rows-3 m-auto gap-2 w-full'>
        ...
        >
          ...
          <span className='text-white font-semibold text-3xl ml-2 absolute -bottom-12 left-1/2 -translate-x-[55%] group-hover:-translate-y-[500%] transition-transform duration-300 whitespace-nowrap'>
            View Projects
          </span>
        </Link>
      </div>
