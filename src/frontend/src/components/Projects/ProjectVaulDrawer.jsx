            ...
            <div className="space-y-3">
              ...
              <Drawer.Close className="w-full">
                <div className="w-full">
                  <button
                    className="w-full text-white rounded-md transition-all hover:opacity-90 duration-150 ease-out bg-neutral-950 dark:bg-neutral-50  px-4 p-2 dark:text-neutral-900"
                    type="submit"
                  >
                    Apply
                  </button>
