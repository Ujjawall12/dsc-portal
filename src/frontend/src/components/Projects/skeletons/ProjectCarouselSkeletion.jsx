    ...
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="max-w-6xl w-full mx-auto p-8 bg-gray-50 dark:bg-[#2D2D2D] rounded-2xl">
        <div className="relative overflow-hidden">
          ...
          {/* Navigation Buttons */}
          <div className="absolute left-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white dark:bg-[#3C3D37] rounded-full animate-pulse" />
          <div className="absolute right-4 top-1/2 -translate-y-1/2 w-10 h-10 bg-white dark:bg-[#3C3D37] rounded-full animate-pulse" />
