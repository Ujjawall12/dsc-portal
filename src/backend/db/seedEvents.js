...
const sampleEvents = [
  {
    ...
    simpleDescription: "Deep dive into advanced React concepts and best practices",
    description: [{
      content: "Join us for an intensive workshop covering React hooks, performance optimization, and state management."
    }]
  },
  {
    images: [
    ...
    description: [{
      content: "Comprehensive workshop on Node.js, Express, and MongoDB integration."
    }]
  },
  {
    images: [
    ...
    description: [{
      content: "Join us for an interactive session on modern DevOps practices and tools."
    }]
  }
];
